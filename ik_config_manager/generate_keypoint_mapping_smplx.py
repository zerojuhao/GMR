...
if __name__ == "__main__":
    ...
    parser.add_argument("--robot_qpos_init", type=str, default="ik_config_manager/pose_inits/rpo_tpose.json",
    ...
    parser.add_argument("--ik_config_in", type=str, 
                        default="general_motion_retargeting/ik_configs/smplx_to_rpo.json",
                        help="输入 IK 配置路径（支持 ik_match_table1&2 字典结构）。")
    parser.add_argument("--ik_config_out", type=str, 
                        default="general_motion_retargeting/ik_configs/smplx_to_rpo_modified.json",
